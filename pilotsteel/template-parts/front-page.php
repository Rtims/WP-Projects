...
get_header(); ?>
    ...
    <div id="carouselExampleIndicators" class="equipment-section equipments projects section-grey ls-section-padding container-fluid clearfix carousel slide" data-ride="carousel">
    	<div class="container">
            <div class="row">
                <div class="section-top section-thead ls-text-align-center col-12 clearfix">
                    <h3 class="thead-border-center">Some of Our Projects</h3>
